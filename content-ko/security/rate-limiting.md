...
모듈을 임포트한 후에는 `ThrottlerGuard`를 어떻게 바인딩할지 선택할 수 있습니다. [가드](https://docs.nestjs.com/guards) 섹션에 언급된 어떤 종류의 바인딩도 가능합니다. 예를 들어, 가드를 전역적으로 바인딩하려면 이 프로바이더를 어떤 모듈에든 추가하면 됩니다.
